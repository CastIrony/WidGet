...
class NodeTest: XCTestCase {
    ...
    func testHandlesBaseUri() {
        do {
            ...
            let noBase = Element(tag, "", attribs)
            ...
            let withBase = Element(tag, "http://foo/", attribs)
            ...
            let dodgyBase = Element(tag, "wtf://no-such-protocol/", attribs)
    ...
    func testBefore() {
        do {
            ...
            let newNode = Element(try Tag.valueOf("em"), "")
    ...
    func testOrphanNodeReturnsNullForSiblingElements() {
        do {
            ...
            let el = Element(try Tag.valueOf("p"), "")
