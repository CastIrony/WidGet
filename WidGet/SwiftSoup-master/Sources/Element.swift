...
open class Element: Node {
     ...
     */
    @discardableResult
    override open func attr(_ attributeKey: String, _ attributeValue: String) throws -> Element {
    ...
    override open func parent() -> Element? {
    ...
    public func iS(_ evaluator: Evaluator) throws -> Bool {
        guard let od = ownerDocument() else {
            return false
        }
     ...
     */
    @discardableResult
    public func insertChildren(_ index: Int, _ children: [Node]) throws -> Element {
    ...
    public func appendText(_ text: String) throws -> Element {
        let node = TextNode(text, getBaseUri())
    ...
    public func append(_ html: String) throws -> Element {
        let nodes: [Node] = try Parser.parseFragment(html, self, getBaseUri())
     ...
     */
    @discardableResult
    override open func before(_ html: String) throws -> Element {
     ...
     */
    @discardableResult
    override open func before(_ node: Node) throws -> Element {
     ...
     */
    @discardableResult
    override open func after(_ html: String) throws -> Element {
     ...
     * @see #before(Node)
     */
    override open func after(_ node: Node) throws -> Element {
     ...
     */
    @discardableResult
    override open func wrap(_ html: String) throws -> Element {
    ...
    public func siblingElements() -> Elements {
        ...
        let elements: [Element]? = parent()?.children().array()
    ...
    public func nextElementSibling() throws -> Element? {
        ...
        let siblings: [Element]? = parent()?.children().array()
    ...
    private static func indexInList(_ search: Element, _ elements: [Element]?) throws -> Int? {
    ...
    public func text(_ text: String) throws -> Element {
        empty()
        let textNode = TextNode(text, baseUri)
     ...
     * {@inheritDoc}
     */
    override open func html(_ appendable: StringBuilder) throws -> StringBuilder {
        for node in childNodes {
