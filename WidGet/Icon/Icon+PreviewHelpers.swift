...
public extension View {
    ...
    /// - Returns: <#description#>
    func frameIcon(dimension: CGFloat = 200) -> some View {
...
public extension View {
    ...
    func previewIcon(dimension: CGFloat = 500) -> some View {
    ...
    func previewHomescreenIcon(dimension _: CGFloat = 100) -> some View {
        VStack(spacing: 10) {
    ...
    func previewHomescreen() -> some View {
