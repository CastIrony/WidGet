...
open class Document: Element {
    ...
    private var _outputSettings = OutputSettings()
    ...
    override open func outerHtml() throws -> String {
     ...
     */
    @discardableResult
    override public func text(_ text: String) throws -> Element {
...
public class OutputSettings: NSCopying {
    ...
    private var _escapeMode = Entities.EscapeMode.base
    private var _encoder = String.Encoding.utf8 // Charset.forName("UTF-8")
