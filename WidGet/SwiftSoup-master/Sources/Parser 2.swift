...
public class Parser {
    ...
    private var _errors = ParseErrorList(16, 16)
     ...
     */
    public static func parseFragment(_ fragmentHtml: String, _ context: Element?, _ baseUri: String) throws -> [Node] {
     ...
     */
    public static func parseXmlFragment(_ fragmentXml: String, _ baseUri: String) throws -> [Node] {
    ...
    public static func parseBodyFragment(_ bodyHtml: String, _ baseUri: String) throws -> Document {
        ...
        if let body: Element = doc.body() {
            let nodeList: [Node] = try parseFragment(bodyHtml, body, baseUri)
    ...
    public static func unescapeEntities(_ string: String, _ inAttribute: Bool) throws -> String {
        let tokeniser = Tokeniser(CharacterReader(string), ParseErrorList.noTracking())
