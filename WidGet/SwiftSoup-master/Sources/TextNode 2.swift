...
open class TextNode: Node {
    ...
    open func splitText(_ offset: Int) throws -> TextNode {
        ...
        text(head)
        let tailNode = TextNode(tail, getBaseUri())
        if parent() != nil {
    ...
    override open func attr(_ attributeKey: String) throws -> String {
        ensureAttributes()
        return try super.attr(attributeKey)
    }

    override open func getAttributes() -> Attributes {
        ensureAttributes()
        return super.getAttributes()!
    }

    override open func attr(_ attributeKey: String, _ attributeValue: String) throws -> Node {
        ensureAttributes()
        return try super.attr(attributeKey, attributeValue)
    }

    override open func hasAttr(_ attributeKey: String) -> Bool {
        ensureAttributes()
        return super.hasAttr(attributeKey)
    }

    override open func removeAttr(_ attributeKey: String) throws -> Node {
        ensureAttributes()
        return try super.removeAttr(attributeKey)
    }

    override open func absUrl(_ attributeKey: String) throws -> String {
        ensureAttributes()
